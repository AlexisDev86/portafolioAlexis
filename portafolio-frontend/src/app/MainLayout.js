...
export default function MainLayout({children}) {
    ...
    // Función para manejar el clic en WhatsApp sin exponer el número
    const handleWhatsAppClick = (e) => {
        e.preventDefault();
        // El número está definido aquí y no directamente en el HTML
        const phoneNumber = "56992433256";
    ...
    return (
        <>
            ...
            {/* Botón de WhatsApp con manejo seguro del número */}
            <a
                href="#"
