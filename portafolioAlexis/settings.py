"""
Django settings for portafolioAlexis project.
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'django_filters',
    'portafolioBackend'  # Manejo de backend
]
...
ROOT_URLCONF = 'portafolioAlexis.urls'
...
WSGI_APPLICATION = 'portafolioAlexis.wsgi.application'
